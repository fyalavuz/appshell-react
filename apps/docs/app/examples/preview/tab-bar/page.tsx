...
const avatars = [
  ...
  { name: "Marcus Johnson", initials: "MJ", color: "from-blue-500 to-cyan-400" },
  { name: "Priya Patel", initials: "PP", color: "from-violet-500 to-purple-400" },
  { name: "Alex Rivera", initials: "AR", color: "from-amber-500 to-orange-400" },
  { name: "Jordan Lee", initials: "JL", color: "from-emerald-500 to-teal-400" },
];
